...
function App() {
  ...
  useEffect(() => {
    switch (urlSearchParams?.toLocaleLowerCase()) {
      ...
      case "experience":
        return setExperienceModal(true);
      case "portfolio":
        return setPortfolioModal(true);
      default:
        break;
    }
  }, []);
    ...
    <motion.div className="p-10 rounded-xl max-w-[1366px] h-screen sm:h-full">
      ...
      >
        <GlowWrapper className="mx-auto md:mx-0">
          <h1
            className="p-0 text-yellow-500 text-3xl font-bold text-center"
            style={{ textShadow: "1px 1px 2px #facc15" }}
          >
        ...
        <p className="text-center md:max-w-[70%] md:text-left text-yellow-100 text-base">
          I'm someone who puts my best effort into my work, making sure I do
          things right. I enjoy learning new things and facing challenges
          without backing down. Instead of being afraid of challenges, I see
          them as chances to grow. I take my duties seriously and make sure to
          finish what I start on time and at a high standard.
        </p>

        <div className="grid md:flex gap-6 py-10">
          <Button onClick={() => setAboutModal(!aboutModal)}>About</Button>
